...
const users = [
  { initials: 'JA', name: 'John Administrator', email: 'john.admin@techcorp.com', role: 'Admin', joined: 'Jan 10, 2024', status: 'active' },
  { initials: 'SJ', name: 'Sarah Johnson', email: 'sarah.johnson@techcorp.com', role: 'Employee', joined: 'Jan 20, 2024', status: 'active' },
  { initials: 'MC', name: 'Michael Chen', email: 'michael.chen@techcorp.com', role: 'Employee', joined: 'Feb 15, 2024', status: 'active' },
  { initials: 'ED', name: 'Emma Davis', email: 'emma.davis@techcorp.com', role: 'Employee', joined: 'Mar 5, 2024', status: 'active' },
  { initials: 'JW', name: 'Jessica Williams', email: 'jessica.williams@techcorp.com', role: 'Employee', joined: 'Apr 12, 2024', status: 'active' },
  { initials: 'DP', name: 'David Park', email: 'david.park@techcorp.com', role: 'Employee', joined: 'May 20, 2024', status: 'active' },
  { initials: 'AF', name: 'Amanda Foster', email: 'amanda.foster@techcorp.com', role: 'Employee', joined: 'Jun 8, 2024', status: 'active' },
];
              ...
              <tr key={u.email}>
                <td className="py-2 pr-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-[11px] font-semibold">{u.initials}</div>
                ...
                <td className="py-2 pr-2 text-right">
                  <button className="px-2 py-1 rounded-lg border border-gray-200 text-gray-500 text-xs hover:bg-gray-50">•••</button>
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-xs font-semibold">SB</div>
