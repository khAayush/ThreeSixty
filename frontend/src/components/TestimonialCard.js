const TestimonialCard = ({ stars, text, name, title, company, initial, color }) => {
  return (
    <div className="bg-white rounded-2xl p-7 shadow-sm border border-gray-100 min-h-[240px] flex flex-col gap-6 hover:shadow-lg transition">
      ...
      <div className="text-gray-800 text-base font-normal leading-relaxed">"{text}"</div>
      <div className="flex items-center gap-4 mt-2">
        <div
          className={`w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 text-lg font-semibold`}
        >
          {initial}
        </div>
        <div>
