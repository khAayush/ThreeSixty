  ...
  return (
    ...
    >
      ...
      <div className="flex gap-12">
        ...
        <a href="#features" className="text-gray-500 hover:text-gray-900 transition">
          Features
        </a>
        <a href="#testimonials" className="text-gray-500 hover:text-gray-900 transition">
          Testimonials
        </a>
        <a href="#footer" className="text-gray-500 hover:text-gray-900 transition">
          About
        </a>
      </div>

      <div className="flex items-center gap-4">
        <a href="/signup" className="text-gray-700 hover:text-gray-900 transition">
          Sign Up
        </a>
        <a
          href="/login"
          className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-5 py-2 transition font-medium"
        >
          Login
        </a>
      </div>
