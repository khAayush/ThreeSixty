            ...
            {loadingAssets ? (
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none pl-3 pr-9 py-2.5 border border-slate-200 rounded-xl text-sm font-mono text-slate-700 focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand"
                >
                  {assets.map((x) => (
