...
const TestimonialSection = () => {
  return (
    <section className="py-16 px-4 md:px-10 lg:px-28 bg-[#fafbfc] text-center" id="testimonials">
      ...
      <div className="text-xl font-medium text-gray-900 mb-2">Trusted by IT Leaders Worldwide</div>
      ...
      <div className="text-gray-400 text-sm mb-3">Powering IT teams at leading companies</div>
